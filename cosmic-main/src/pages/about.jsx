        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-4 mt-6">
              <button onClick={prev} className="w-12 h-12 sm:w-14 sm:h-14 rounded-md bg-accent-500 flex items-center justify-center hover:bg-accent-600 transition">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                </svg>
              </button>
              <button onClick={next} className="w-12 h-12 sm:w-14 sm:h-14 rounded-md bg-accent-500 flex items-center justify-center hover:bg-accent-600 transition">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
